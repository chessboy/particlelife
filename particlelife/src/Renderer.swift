...
class Renderer: NSObject, MTKViewDelegate, ObservableObject {
    @Published var fps: Int = 0  // ✅ Observable FPS
    ...
    func draw(in view: MTKView) {
        ...
        if currentTime - lastUpdateTime >= 1.0 {  // ✅ Only reset FPS every second
            let capturedFPS = frameCount  // ✅ Save before resetting

            DispatchQueue.main.async {
                self.fps = capturedFPS  // ✅ Ensure FPS gets updated
