...
class RenderPass {
    ...
    func encode(commandBuffer: MTLCommandBuffer,
        ...
        renderEncoder.setVertexBuffer(bufferManager.renderSettingsBuffer, offset: 0, index: 3)

        renderEncoder.setFragmentBuffer(bufferManager.renderSettingsBuffer, offset: 0, index: 0)
